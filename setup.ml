...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0fb54bb9a2f9138cb217ff780bedd69c) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ffi_bindings"; "Ffi_types"; "Typedefs"];
                      lib_pack = false;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "binaryninja_bindings";
                      ...
                      bs_cclib =
                        [
                           (OASISExpr.EBool true,
                             [
                                "-L/home/aziem/Downloads/binaryninja";
                                "-lbinaryninjacore"
                             ])
                        ];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                   ...
                   },
                   {
                      ...
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "binaryninja";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Binary Ninja";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = ".";
                      bs_compiled_object = Native;
                      bs_build_depends = [InternalLibrary "binaryninja"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\212\141f\019]H\128I\195\162p\206g\224\188\202";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
